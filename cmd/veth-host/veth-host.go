...
func setupContainerVeth(netns ns.NetNS, serviceCidr string, ifName string, mtu int, hostAddrs []netlink.Addr, masq, containerIPV4, containerIPV6 bool, k8sIfName string, pr *current.Result) (*current.Interface, *current.Interface, error) {
	...
	err := netns.Do(func(hostNS ns.NetNS) error {
		...
		// add a service cidr gateway pointed at the first hostAddr
